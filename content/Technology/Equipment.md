...
*Field gear, sensors, tools, and consumables carried by operators across the Sector. From basic survival kit to specialist electronics — everything that isn't a weapon and isn't worn.*
...
**Personal Comm Unit:** AV: C. Standalone field radio for operators without integrated armor comms. Short-to-Long range voice capability. Not TacLink-compatible. BCL-3, MCA-7, compression suits, and EVX-9 all have integrated comms; this unit is for operators in lighter gear who need radio capability. Standard kit for auxiliary personnel, militia, and contractors running lighter armor configurations.

**Noise-Cancelling Comm Headset:** AV: R. Over-helmet or standalone noise-cancelling comm headset. Allows clear voice communication in active combat, heavy machinery operation, adverse weather, and engine rooms. For operators in SCA-12, MCA-7, BDU, or lighter — BCL-3 and above already incorporate noise-cancellation as standard in their integrated comm systems.
...
The FieldSeal Patch is the primary response to a **Suit Breach** — the condition triggered when a hit penetrates sealed armor and compromises the environmental seal, causing accelerated Air Supply loss. Without a kit, an improvised field repair requires a Full Action and a HEAVY MACHINERY roll, and the result is degraded rather than fully restored. *See [[Armor & Apparel#Suit Breach]] for the full mechanic.*

Standard carry for operators running sealed armor in environments where a breach is a mission-ending problem. A professional carries two.
...
**Nano-Weave Field Shelter:** AV: R. Deployable military-grade shelter constructed from nano-woven carbon composite panels — rated to stop small arms at one layer. Capacity 2–4 occupants. When sealed, protects all occupants against chemical and biological atmospheric hazards, radiation (6 base dice per Rad event; 1+ success = absorbed), and extreme temperatures from −40°C to +60°C. Stationary with camouflage exterior. Powered; when power fails, thermal regulation and environmental sealing end. Connect to a Portable Generator to bypass power tracking entirely.

**Portable Generator:** AV: R. Portable field generator that connects via cable to powered equipment in the same zone. When connected and running, powered equipment does not need to track power supply. Powers the Sonic Perimeter Grid at high-intensity mode, the Nano-Weave Field Shelter, Plasma Cutter extended operations, and other high-draw systems. Runs on fuel; refuel cost is minimal.

**Power Cell:** AV: C. Restores full power supply to one item. Quick Action to swap. The standard carry item for any operator running powered gear on extended operations — cutting torches, plasma cutters, cybernetic limbs, sensor equipment.
